...
|---|---|---|
| 0:00 | Empty note, cursor blinking | "This is JotRelay." |
...
| 0:21 | End card | "JotRelay. Real-time sync. No account needed." |
...
- The last line ("JotRelay. Real-time sync. No account needed.") doubles as
