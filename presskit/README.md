...
`video/demo.mp4` — the hero's autoplay loop (24.6s, silent). It's a genuine
screen capture of the real app (typing, live sync between two simulated
devices, the Share modal, a file landing in the Files panel), not a mockup,
generated by `scripts/generate-demo-video.mjs`. `video/narration-script.md`
is a script sized to its beats, ready to hand to a voiceover/editing tool
if you want to produce a narrated cut. See [`video/README.md`](video/README.md)
for the full story and how to upgrade it.
