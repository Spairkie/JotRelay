...
presskit/
  ...
  video/              — demo video slot (placeholder — see video/README.md)
```
...
`video/` is currently empty aside from a README describing the expected
filename and format for the product demo video referenced on the landing
page. See [`video/README.md`](video/README.md).
