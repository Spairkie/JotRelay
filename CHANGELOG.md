...
- **Seven real bugs found in `0010`/`0011` across two rounds of review of this same change, all fixed and re-verified against a real Postgres instance rather than assumed correct from the diff:**
