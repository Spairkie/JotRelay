...
//     several-thousand-entry set — see markdown-emoji-map.js); an unrecognized
...
function _renderInlineNode(node, text, ctx) {
  ...
  switch (name) {
    ...
    case 'Emoji': {
      ...
      return Object.prototype.hasOwnProperty.call(EMOJI_MAP, code) ? EMOJI_MAP[code] : escapeHtml(raw);
    }
    case 'URL':
